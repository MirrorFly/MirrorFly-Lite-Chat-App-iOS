...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/MirrorFlySDK/MirrorFlySDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/MirrorflyUIKit/FlyUIKit.framework"
fi
